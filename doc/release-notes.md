vizeh Core version 2.2.1 is now available from:

  <https://github.com/VIZEH-PROJECT/vizeh/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/VIZEH-PROJECT/vizeh/issues>

Compatibility
==============

vizeh Core is extensively tested on multiple operating systems using
...
vizeh Core should also work on most other Unix-like systems but is not
...
of Bitcoin that vizeh was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/VIZEH-PROJECT-translations/).
