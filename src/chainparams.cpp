...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x00000d5c781fe3e37acb47fd4459054db41c6aa2d57c9f374dd57b3edfd3638e"));
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1520356832;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21628150;
        ...
        vSeeds.push_back(CDNSSeedData("01", "35.194.71.36"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("seed1", "vizeh-testnet.seed.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "vizeh-testnet.seed2.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "vizeh-testnet.seed3.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "vizeh-testnet.seed4.com"));
